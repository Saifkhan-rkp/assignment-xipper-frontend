                                    ...
                                    <div key={item.id} className="mt-4 flex flex-row justify-start items-start space-y-4 space-x-8 w-full">
                                        ...
                                        <div className="border-b border-gray-200 flex-row flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                                            ...
                                            <div className="flex justify-between space-x-8 items-start w-full">
                                                <p className="text-lg leading-6">{item.price} {orderDetails.currency}</p>
                                                <p className="text-lg font-semibold leading-6 text-gray-800">{(item.price * item.quantity).toFixed(2)} {orderDetails.currency}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                                ...
                                <div className="flex flex-col px-4 py-6 md:p-6 p-8 w-full bg-gray-50 space-y-6">
                                    ...
                                    <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                                        <div className="flex justify-between w-full">
                                            ...
                                            <p className="text-base leading-4 text-gray-600">{orderDetails?.subtotal_price} {orderDetails.currency}</p>
                                        </div>
                                            ...
                                            <div key={line.id} className="flex justify-between items-center w-full">
                                                <div className="flex justify-center items-center space-x-4">
                                                    ...
                                                    <div className="flex flex-col justify-start items-center">
                                                        <p className="text-lg leading-6 font-semibold text-gray-800">{line.title}<br /><span className="font-normal">Price: {line.price} {orderDetails.currency}</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
